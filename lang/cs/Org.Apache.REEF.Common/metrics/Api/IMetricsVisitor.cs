...
namespace Org.Apache.REEF.Common.metrics.Api
{
    ...
    /// is lost. For example, <see cref="AbstractMetric"/> loses any information about the derived class 
    ...
    /// example be used by <see cref="IMetricsSink"/> to get specific information about metrics 
    ...
    public interface IMetricsVisitor
    {
        ...
        /// <param name="value">Integer value of the gauge.</param>
        void Gauge(IMetricsInfo info, int value);
        ...
        /// </summary>
        /// <param name="info">Meta-data of the metric.</param>
        /// <param name="value">Float value of the gauge.</param>
        void Gauge(IMetricsInfo info, float value);
        ...
        /// <summary>
        /// Callback for integer value counter
        /// </summary>
        /// <param name="info">Meta-data of the metric.</param>
        /// <param name="value">Integer value of the counter.</param>
        void Counter(IMetricsInfo info, int value);
